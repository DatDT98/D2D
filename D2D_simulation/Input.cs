...
namespace D2D_simulation
{
    class Input
    {
        ...
        public static int NumberofSBS = 20;
        public static int NumberofChannel = 50;
        public static int NumberofBWP = 5;
        public static int NumberOfBWP_permit = 4;


        public static int NumberofBWP_SUE = 3;
        public static int NumberofBWP_D2D = NumberOfBWP_permit - NumberofBWP_SUE;
        public static int NumberofSUE = (NumberofChannel/ NumberofBWP) * NumberofBWP_SUE;
        public static int NumberofPair = (NumberofChannel / NumberofBWP) * NumberofBWP_D2D;
        
        public static double k = 1; // ratio power permit
        ...
        //Noi luu tru file
        public static string path = "A:\\Du_an\\result";
    }
}
